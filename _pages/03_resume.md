...
### [2026-] IBM Research, Consulting Engineer (Through CTG Inc.)
...
* [Python][coursera-dl-code], [R][coursera-r]. Bit of [Scala][coursera-scala1], [Swift][swift], [MATLAB][coursera-ml-code].
* Expert linux user.
